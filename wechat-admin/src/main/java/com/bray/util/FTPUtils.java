...
import com.bray.config.FTPConfig;
...
/**
 * @author:wuzhiyuan
 * @description: ftp相关服务操作
 * @date: Created in 13:00 2018/1/27
 * @modified By:
 */
public class FTPUtils {
    ...
    public FTPUtils(FTPConfig ftpConfig) {
        ...
        basePath=ftpConfig.getBasePath();
    }
    /**
     *
...
//        //上传测试--------------------------------------
//        try( FileInputStream in=new FileInputStream(new File("E:\\touxiang.jpg"))){
//            FTPUtils FTPUtils=new FTPUtils();
//            boolean flag=FTPUtils.fileUpload("/20180127", "touxiang.jpg", in);
