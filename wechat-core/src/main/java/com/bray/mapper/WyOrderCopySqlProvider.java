...
import com.bray.model.WyOrderCopyExample.Criteria;
import com.bray.model.WyOrderCopyExample.Criterion;
import com.bray.model.WyOrderCopyExample;
import java.util.List;
import java.util.Map;

public class WyOrderCopySqlProvider {

    public String countByExample(WyOrderCopyExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("wy_order_copy");
    ...
    public String deleteByExample(WyOrderCopyExample example) {
        BEGIN();
        DELETE_FROM("wy_order_copy");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(WyOrderCopy record) {
        BEGIN();
        INSERT_INTO("wy_order_copy");
    ...
    public String selectByExample(WyOrderCopyExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WyOrderCopy record = (WyOrderCopy) parameter.get("record");
        WyOrderCopyExample example = (WyOrderCopyExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(WyOrderCopy record) {
        BEGIN();
        UPDATE("wy_order_copy");
    ...
    protected void applyWhere(WyOrderCopyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
