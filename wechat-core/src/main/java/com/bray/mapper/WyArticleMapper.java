...
public interface WyArticleMapper {
    ...
    @Insert({
        ...
        "read_original_url, order_img_url, ",
        "order_copy_url, statistical, ",
        ...
        "#{readOriginalUrl,jdbcType=VARCHAR}, #{orderImgUrl,jdbcType=VARCHAR}, ",
        "#{orderCopyUrl,jdbcType=VARCHAR}, #{statistical,jdbcType=VARCHAR}, ",
    ...
    @Select({
        ...
        "data_transfer_url, goback_url, read_original_url, order_img_url, order_copy_url, ",
        "statistical, connect_primary_domain, connect_common_domain, is_publish, forced_share, ",
        "no_share_domain, status, create_time, update_time",
        "from wy_article",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
