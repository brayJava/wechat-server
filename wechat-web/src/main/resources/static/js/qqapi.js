...
!function(a, b, c) {
        ...
        function(a, b) {
            ...
            function f(b, c, d, e, f) {
                if (b && c && d) {
                    var g, h, i, j, k = b + "://" + c + "/" + d;
                    if (e = e || [], !f || !O[f] && !window[f]) for (f = null, h = 0, i = e.length; h < i; h++) if (g = e[h], a.isObject(g) && (g = g.callbackName || g.callback), g && (O[g] || window[g])) {
                        f = g;
                        break
                    }
                    f && (P[f] = {
                    ...
                    (j = String(f).match(/__MQQ_CALLBACK_(\d+)/)) && (P[j[1]] = P[f])),
                        C.send(k, T)
                }
            }
            function g(a) {
            ...
            function h(b, c, d) {
                var e, f;
                if (b = a.isFunction(b) ? b: window[b]) return e = i(b),
                    f = "__MQQ_CALLBACK_" + e,
                    window[f] = function() {
            ...
            function j(a) {
                ...
                for (c = 0, d = e.length; c < d; c++) if (e[c] in a) {
                    b = a[e[c]];
                    break
                }
                return b
            ...
            function k(d, f, g, h) {
                ...
                f = f || [],
                    i = f[0],
                a.isUndefined(h) && (h = !0),
                a.isObject(i) && ("data" in i || (i.data = c({},
                    i)), "code" in i || (i.code = j(i) || 0), i.msg = i.msg || ""),
                    a.isFunction(m) ? h ? setTimeout(function() {
                            m.apply(null, f)
                        },
                        0) : m.apply(null, f) : console.log("mqqapi: not found such callback: " + d + " or the callback: " + d + " had some errors! API: " + d.name),
                g && (delete O[d], delete window["__MQQ_CALLBACK_" + d]),
                P[d] && (l = P[d], delete P[d], e({
                    from: "fireCallback",
                    ns: l.ns,
                    method: l.method,
            ...
            function o(b) {
                ...
                return c = Q[f] || Q[b.replace("qw.", "mqq.").replace("qa.", "mqq.")],
                a.isObject(c) && (c = c[a.iOS ? "iOS": a.android ? "android": "browser"]),
                !!c && (d = c.split("-"), 1 === d.length ? a.compare(d[0]) > -1 : a.compare(d[0]) > -1 && a.compare(d[1]) < 1)
            }
            function p(c, d, f, g) {
                function h() {
                    l(g, {
                ...
                k.style.cssText = "display:none;width:0px;height:0px;",
                    k.onerror = function(a) {
                        a.stopPropagation()
                    },
                a.iOS && (k.onload = h, k.src = c);
                var m = document.body || document.documentElement;
                return m.appendChild && m.appendChild(k),
                a.android && (k.onload = h, k.src = c),
                    j = c.indexOf("mqqapi://") > -1 && a.android ? 0 : 500,
                    setTimeout(function() {
            ...
            function u(b, c, d, e, g) {
                ...
                e.version || (e.version = 1),
                    j = b + "://" + encodeURIComponent(c) + "/" + encodeURIComponent(d) + "?" + w(e),
                    p(j, c, d),
                    f(b, c, d, k, i)
            }
            function v(a) {
                var b, c, d, e, f = a.indexOf("?"),
                    ...
                    h = {};
                for (b = 0; b < g.length; b++) e = g[b],
                    f = e.indexOf("="),
                    -1 === f ? h[e] = "": (c = e.substring(0, f), d = e.substring(f + 1), h[c] = decodeURIComponent(d));
                return h
            }
            function w(a) {
                var b, c, d = [];
            ...
            function x(a, b) {
                ...
                return d.href = a,
                d.search && (c = v(String(d.search).substring(1)), b.forEach(function(a) {
                    delete c[a]
                }), d.search = "?" + w(c)),
                    a = d.href,
                    d = null,
            ...
            function B(b, c, d) {
                ...
                a.android && !1 === g.options.broadcast && a.compare("5.2") <= 0 && (g.options.domains = ["localhost"], g.options.broadcast = !0),
            ...
            return E ? (a.debuging = !0, D = E.ua || D) : a.debuging = !1,
                c(a,
                    function() {
                        var a = {};
            ...
            a.iOS && a.android && (a.iOS = !1),
                ...
                a.platform = function() {
                    var c, e, f = "browser";
                    return a.android && ((c = D.match(L)) && c.length ? (a.QQVersion = a.clientVersion = (d(c[1], c[3]) >= 0 ? c[1] : c[3]) || "0", f = "AndroidQQ") : (c = D.match(N)) && c.length && (a.clientVersion = c[1] || "0", f = "AndroidTribe"), window.JsBridge = window.JsBridge || {},
                        window.JsBridge.callMethod = s, window.JsBridge.callback = l, window.JsBridge.compareVersion = a.compare),
                    a.iOS && (a.__RETURN_VALUE = b, (c = D.match(K)) && c.length ? (a.clientVersion = c[1] || "0", a.QQVersion = c[2] || a.clientVersion, f = "iPadQQ") : (c = D.match(J)) && c.length ? (a.QQVersion = a.clientVersion = c[1] || "0", f = "iPhoneQQ") : (c = D.match(N)) && c.length ? (a.clientVersion = c[1] || "0", f = "iOSTribe") : (e = s("device", "qqVersion")) && (a.QQVersion = a.clientVersion = e, f = "iPhoneQQ"), window.iOSQQApi = a),
                        f
                } (),
                S = function() {
                    var a, b = 1;
    ...
    function(a) {
        ...
        window.JsBridge || (window.JsBridge = {}),
            ...
            c(e),
            c(f, "4.5"),
            k ? /\bPA\b/.test(j) || mqq.compare("4.6") >= 0 ? (c(g), c(h, "4.5"), c(i, "4.5")) : /\bQR\b/.test(j) && (c(i, "4.5"), mqq.compare("4.5") >= 0 && mqq.compare("4.6") < 0 && (window.publicAccount = {
                openUrl: function(a) {
                    location.href = a
                }
            })) : c(g, "4.2")
    ...
    mqq.build("mqq.app.launchApp", {
        iOS: function(a, b) {
            if (a) {
                a && a.name && (b = a, a = a.name, delete a.name),
                -1 == a.indexOf("://") && (a += "://");
                var c = a;
                b && (c = a + (a.indexOf("?") > -1 ? "&": "?") + mqq.toQuery(b)),
                    mqq.invokeURL(c)
            }
        },
        android: function(a) {
            a && a.name && (a = a.name),
                mqq.invokeClient("QQApi", "startAppWithPkgName", a)
        },
        supportInvoke: !0,
        support: {
            iOS: "4.2",
    ...
    function() {
        var a = function(a, b) {
            ...
            b = function(b, c) {
                c && (b.callback = mqq.callback(a(b.type, c))),
        ...
        var a = function(a) {
            ...
            b = function(b) {
                if (mqq.compare("4.7.1") >= 0) mqq.invokeClient("qw_data", "getPerformance", a(b));
                    ...
                    b({
                        result: -1,
                        message: "璇ユ帴鍙ｅ湪鎵婹 v4.7.1 鎴栦互涓婃墠鏀寔锛�",
                        data: null
                    })
                }
            };
            ...
            h = function(a) {
                return "function" == typeof a ?
                    function(b) {
                        ...
                        "object" == typeof b && b.value && (c = 0, d = parseInt(b.value), d = d || 0),
                        a && a({
                            code: c,
                            time: d
                        })
    ...
    function() {
        var a = function(a) {
            ...
            b = function(b, c) {
                var d, e, f = a(b);
                if ("object" === f && mqq.compare("5.8.0") >= 0) return d = {},
                    d.id = "webviewDebugLog_" + b.id,
                    d.subid = b.subid,
                    d.content = b.content,
                    d.isall = !1,
                "string" === a(b.level) && ("debug" != (e = b.level.toLowerCase()) && "info" != e && "error" != e || (d.level = e)),
                    d.level = d.level || "info",
                    d.content = d.content ? d.content: "",
                    d.content = d.level + "|" + d.content,
                "error" == d.level && (d.isall = !0),
                    mqq.invokeClient("qw_debug", "detailLog", d)
            };
    ...
    mqq.build("mqq.debug.hide", {
        iOS: function(a) {
            if (mqq.compare("4.7.1") >= 0) return null == a && (a = !0),
    ...
    mqq.build("mqq.nfc.addTagDiscoveredListener", {
        android: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
                mqq.addEventListener("tagDiscovered", b)
        },
        iOS: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
    ...
    mqq.build("mqq.nfc.getNfcStatus", {
        android: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
                mqq.invokeClient("nfc", "getNfcStatus", JSON.stringify(a), b)
        },
        iOS: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
    ...
    mqq.build("mqq.nfc.nfcInit", {
        android: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
                mqq.invokeClient("nfc", "nfcInit", JSON.stringify(a), b)
        },
        iOS: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
    ...
    mqq.build("mqq.nfc.nfcTranceive", {
        android: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
                mqq.invokeClient("nfc", "nfcTranceive", JSON.stringify(a), b)
        },
        iOS: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
    ...
    mqq.build("mqq.nfc.nfcUnInit", {
        android: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
                mqq.invokeClient("nfc", "nfcUnInit", JSON.stringify(a), b)
        },
        iOS: function(a, b) {
            a = a || {},
            b && (a.callback = mqq.callback(b)),
    ...
    function() {
        function a(a) {
            var b = null;
            if (!1 === e && (e = "" == location.search ? "" == location.hash ? "": location.hash.substring(1) : location.search.substring(1), e = e.split("&"), e.length > 0)) for (var c = 0; c < e.length; c++) if (b = e[c], b = b.split("="), b.length > 1) try {
        ...
        function d(a, b) {
            if (0 == a.code) {
                var c = {
                    ...
                    d = a.data.buffer;
                if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d, void 0 !== d.msg) for (var e in d.msg) 1 == d.msg[e].stat && c.count++;
                l[b].call(null, c)
            } else l[b].call(null, {
                ret: a.code,
                list: []
    ...
    function() {
        var a = function(a, b) {
            ...
            for (var c = ["path", "service_type", "service_id", "act_id", "obj_id", "pay_amt"], d = 0, e = c.length; d < e; ++d) if (void 0 === a[c[d]]) return b({
                code: -1,
        ...
        return function(b, c, d) {
            ...
            if (0 === b) {
                ...
                c.time_end && (c.pay_time = c.time_end),
                    e.data = c
            } else 1 === b || -1 === b ? (e.retmsg = "鐢ㄦ埛涓诲姩鏀惧純鏀粯", e.resultCode = -1) : e.retmsg = c;
            a && a(e)
        }
    };
    mqq.build("mqq.tenpay.pay", {
        iOS: function(b, c) {
            b.order_no = b.tokenId || b.tokenID || b.prepayId,
        ...
        android: function(b, c) {
            b.tokenId = b.tokenId || b.tokenID || b.prepayId,
                b.app_info = b.app_info || b.appInfo,
...
function() {
    ...
    function b(a) {
        return a && 0 === a.indexOf("//") && (a = window.location.protocol + a),
            a
    }
    var c = {},
        d = 500;
