...
import com.bray.service.wechat.bean.*;
...
public class WechatTemplateMessageServiceImpl implements WechatTemplateMessageServcie {
    ...
    private void sendWechatMsg(String openid, OrderTemplateKeyParam orderTemplateKeyParam) {
        ...
        DataInfo keyword2 = new DataInfo(orderTemplateKeyParam.getOrderMoneySum(), "");
        DataInfo keyword3 = new DataInfo(orderTemplateKeyParam.getBackupFieldName(), "");
        DataInfo keyword4= new DataInfo(orderTemplateKeyParam.getBackupFieldData(), "");
        DataInfo remark= new DataInfo(orderTemplateKeyParam.getRemark(), "#173177");

        OrderTemplateKeyword templateKeyword = new OrderTemplateKeyword(first, keyword1, keyword2,keyword3,keyword4,remark);
        //设置模板参数
